...
export default function Details(props) {
  ...
  useEffect(() => {
    ...
    return () => {
      console.log(`Clean up right before component is removed from DOM`);
    }
  }, [])
  ...
  useEffect(() => {
    ...
    return () => {
      console.log(`clean up after the effect of the previous render of the component`);
    }
  })
  ...
  useEffect(() => {
    // this runs after first render for sure and then after every render + dom surgery
