...
UndergroundSystem.prototype.checkOut = function(id, stationName, t) {
    let startStation = this.timeMap[id][0];
    let startTime = this.timeMap[id][1];
    let totalTime = t - startTime;
    let key = startStation+"_"+stationName;


    if (!this.stationMap[key]){
        this.stationMap[key] = [totalTime, 1]
    } else {
        this.stationMap[key][0] += totalTime;
        this.stationMap[key][1]++
    }
...
UndergroundSystem.prototype.getAverageTime = function(startStation, endStation) {
    ...
    let totalTime = this.stationMap[key][0];
    let totalTravel = this.stationMap[key][1];
