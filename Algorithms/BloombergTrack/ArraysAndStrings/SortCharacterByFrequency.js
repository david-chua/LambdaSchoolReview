...
4. loop through string and fill hashmap with key - character, value: num times
seen in string
5. loop through finished object and fill in bucket with
frequency as index which contains a sorted letters
6. for loop looks like n^2 but in reality, bucket length is as many characters
and buckets[i] can only be up to string length. 
