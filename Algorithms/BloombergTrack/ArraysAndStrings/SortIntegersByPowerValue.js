...
interval [lo, hi] by the power value in ascending order,
...
transform into 1 using these steps and that the power of x is will fit in 32 bit
signed integer.
...
2. for each item from low to hi, store the buckets[steps] with in an array containing
the values of i
